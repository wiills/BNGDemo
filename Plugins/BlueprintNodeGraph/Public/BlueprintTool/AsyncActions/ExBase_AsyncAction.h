 ...
 *
 * @note �?ExK2Node_LatentTaskCall 调用
 ...
 * @brief 带成�?失败委托的异步操作代理类
 *
 * 继承�?UExBase_AsyncAction，添加了成功和失败两个委托，
 * 用于通知调用方操作的执行结果�?
 */
UCLASS()
